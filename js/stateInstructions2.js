var StateInstructions2 = {
    ...
    create: function () {
        ...
        this.vengeStart.scale.setTo(0.4, 0.4);
        ...
        this.backstory1 = game.add.text(game.world.centerX, 130, "they used to make fun of mondo");
        this.backstory1.anchor.set(0.5, 0.5);
        this.backstory2 = game.add.text(game.world.centerX, 160, "but today he got out of the house");
        this.backstory2.anchor.set(0.5, 0.5);
        this.instruc1 = game.add.text(game.world.centerX, 190, "EAT DA FOOD:  jump button / up arrow");
        this.instruc1.anchor.set(0.5, 0.5);
        this.instruc2 = game.add.text(game.world.centerX, 220, "EAT DA HATERS: belly bop / down arrow");
        this.instruc2.anchor.set(0.5, 0.5);
        this.instruc3 = game.add.text(game.world.centerX, 260, "claim as many vengence points as you can...");
